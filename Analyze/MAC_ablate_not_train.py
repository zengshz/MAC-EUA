...
def smac_transformer_train_panel():
    ...
    # 模型初始化
    # =======================
    model = MACAllocator_Ablate_NOT(d_model = d_model,
        dropout = dropout,
    ...
    ema_model = MACAllocator_Ablate_NOT(d_model = d_model,
        dropout = dropout,
        user_feature_dim = user_feature_dim,
        server_feature_dim = server_feature_dim,
        server_state_dim = server_state_dim,
