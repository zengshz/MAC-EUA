...
def MAC_train_normal():
    ...
    model_dir = f"./model/MACAllocator/{time.strftime('%m%d%H%M')}_server_{server_percent}_user_{user_num}_miu_{miu}_sigma_{sigma}"
